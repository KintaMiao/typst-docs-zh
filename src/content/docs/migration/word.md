...
:::tip
在阅读本文前，请确保你已经了解了 [Typst](https://typst.app/) 是什么并且已经[安装了 Typst 的运行环境](/tutorial/1-installing-typst/)。
:::
...
![为什么中文字体这么奇怪](./20240715132539.eA-fB0cd.png)
